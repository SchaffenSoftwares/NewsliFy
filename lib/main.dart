                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text("KEEPS YOUR LIFE UP-TO-DATE",
                                style: TextStyle(color: Colors.blue[900], fontFamily: 'Lato', fontSize: 20, fontWeight: FontWeight.bold)),
                          ),
                          Padding(
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: Text("POWERED BY SCHAFFENS",
                                    style: TextStyle(color: Colors.blue[900], fontFamily: 'Poppins-Bold', fontSize: 18,fontWeight: FontWeight.bold)),),
